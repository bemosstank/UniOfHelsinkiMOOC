    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (number == 0) {
              ...
              // "else if" it will reference user inputted number is less than 0, if it is, it will move to the next block  
            } else if (number < 0) {
        ...
        // This will print the string literal "Number of negative numbers: " plus it reference variable type int name count and into it into the Ouput
